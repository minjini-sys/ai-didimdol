export const TASK_TYPES = [
  ...
  },
  {
    ...
    keywords: ["확인", "진짜", "가짜", "위험", "사기", "보이스피싱", "검증", "맞는지", "필요할까", "대체", "도움", "분류"]
  },
  {
    id: "create",
    label: "만들기",
  ...
  },
  {
    ...
    keywords: ["정리", "요약", "표", "체크리스트", "분류", "목록", "분석"]
  },
  {
    id: "connect",
    label: "연결하기",
    description: "파일, 일정, GitHub, 공공데이터, 외부 서비스와 연결한다.",
    keywords: ["파일", "깃허브", "github", "캘린더", "구글시트", "구글 시트", "스프레드시트", "노션", "notion", "공공데이터", "연결", "저장", "보내줘"]
  }
];
